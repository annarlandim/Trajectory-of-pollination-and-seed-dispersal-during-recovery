...
#   data = data_scaled,
#   chains = 4, cores = 4, iter = 4000,
#   file = "output/SEM_models/fit_sdlng_20"
# )
...
#   data = data_scaled,
#   chains = 4, cores = 4, iter = 4000,
#   file = "output/SEM_models/fit_sdlng_21"
# )
...
#   data = data_scaled,
#   chains = 4, cores = 4, iter = 4000,
#   file = "output/SEM_models/fit_sdlng_22"
# )
...
#   data = data_scaled,
#   chains = 4, cores = 4, iter = 4000,
#   file = "output/SEM_models/fit_sdlng_23"
# )
...
#   data = data_scaled,
#   chains = 4, cores = 4, iter = 4000,
#   file = "output/SEM_models/fit_sdlng_24"
# )
...
#   data = data_scaled,
#   chains = 4, cores = 4, iter = 4000,
#   file = "output/SEM_models/fit_sdlng_25"
# )
...
#   data = data_scaled,
#   chains = 4, cores = 4, iter = 4000,
#   file = "output/SEM_models/fit_sdlng_26"
# )
...
#   data = data_scaled,
#   chains = 4, cores = 4, iter = 4000,
#   file = "output/SEM_models/fit_sdlng_27"
# )
...
#   data = data_scaled,
#   chains = 4, cores = 4, iter = 4000,
#   file = "output/SEM_models/fit_sdlng_28"
# )
...
#   data = data_scaled,
#   chains = 4, cores = 4, iter = 4000,
#   file = "output/SEM_models/fit_sdlng_29"
# )
...
#   data = data_scaled,
#   chains = 4, cores = 4, iter = 4000,
#   file = "output/SEM_models/fit_sdlng_30"
# )
...
#   data = data_scaled,
#   chains = 4, cores = 4, iter = 4000,
#   file = "output/SEM_models/fit_sdlng_31"
# )
...
loo_compare(loo_sdlng_0, loo_sdlng_1, loo_sdlng_2, loo_sdlng_3, 
            # loo_sdlng_4, loo_sdlng_5, loo_sdlng_6, loo_sdlng_7, loo_sdlng_8, loo_sdlng_9, loo_sdlng_10, loo_sdlng_11, loo_sdlng_12, loo_sdlng_13, loo_sdlng_14, loo_sdlng_15,
            loo_sdlng_16, loo_sdlng_17, loo_sdlng_18, loo_sdlng_19 
            # loo_sdlng_20, loo_sdlng_21, loo_sdlng_22, 
            # loo_sdlng_23,
...
pp_check(fit_final, resp = "multisd")
pp_check(fit_final, resp = "FDSeeds")
