...
# bf_seeds_A <- bf(ShnSeeds | mi() ~ multi_pol + multi_sd + ConIndex + StrIndex) 
# bf_sdlng_A <- bf(ShnSdlng | mi() ~ mi(ShnSeeds) + ConIndex + StrIndex)        
# 
# fit_full <- brm(
#   bf_pol_A + bf_sd_A + bf_seeds_A + bf_sdlng_A + set_rescor(FALSE),
#   data = data_scaled, cores = 4, chains = 4, iter = 4000,
#   file = "output/SEM_models/fit_full_rec_shn"
# )
...
fit_pol_1 <- brm(
  ...
  file = "output/SEM_models/fit_pol_1_rec_shn"
)
# fit_pol_1 <- readRDS("output/SEM_models/fit_pol_1_rec_shn.RDS")

fit_pol_2 <- brm(
  multi_pol ~ StrIndex,
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_pol_2_rec_shn"
)
# fit_pol_2 <- readRDS("output/SEM_models/fit_pol_2_rec_shn.RDS")

fit_pol_3 <- brm(
  multi_pol ~ ConIndex + StrIndex,
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_pol_3_rec_shn"
)
# fit_pol_3 <- readRDS("output/SEM_models/fit_pol_3_rec_shn.RDS")

fit_pol_0 <- brm(
  multi_pol ~ 1,
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_pol_0_rec_shn"
)
# fit_pol_0 <- readRDS("output/SEM_models/fit_pol_0_rec_shn.RDS")
...
fit_sd_1 <- brm(
  ...
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_sd_1_rec_shn"
)
...
fit_seeds_0 <- brm(
  ...
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_seeds_0_rec_shn"
)
fit_seeds_0 <- readRDS("output/SEM_models/fit_seeds_0_rec_shn.RDS")
...
fit_seeds_1 <- brm(
  ...
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_seeds_1_rec_shn"
)
fit_seeds_1 <- readRDS("output/SEM_models/fit_seeds_1_rec_shn.RDS")
...
fit_seeds_2 <- brm(
  ...
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_seeds_2_rec_shn"
)
fit_seeds_2 <- readRDS("output/SEM_models/fit_seeds_2_rec_shn.RDS")
...
fit_seeds_3 <- brm(
  ...
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_seeds_3_rec_shn"
)
fit_seeds_3 <- readRDS("output/SEM_models/fit_seeds_3_rec_shn.RDS")
...
fit_seeds_4 <- brm(
  ...
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_seeds_4_rec_shn"
)
fit_seeds_4 <- readRDS("output/SEM_models/fit_seeds_4_rec_shn.RDS")
...
fit_seeds_5 <- brm(
  ...
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_seeds_5_rec_shn"
)
fit_seeds_5 <- readRDS("output/SEM_models/fit_seeds_5_rec_shn.RDS")
...
fit_seeds_6 <- brm(
  ...
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_seeds_6_rec_shn"
)
fit_seeds_6 <- readRDS("output/SEM_models/fit_seeds_6_rec_shn.RDS")
...
fit_seeds_7 <- brm(
  ...
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_seeds_7_rec_shn"
)
fit_seeds_7 <- readRDS("output/SEM_models/fit_seeds_7_rec_shn.RDS")
...
fit_seeds_8 <- brm(
  ...
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_seeds_8_rec_shn"
)
fit_seeds_8 <- readRDS("output/SEM_models/fit_seeds_8_rec_shn.RDS")
...
fit_seeds_9 <- brm(
  ...
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_seeds_9_rec_shn"
)
fit_seeds_9 <- readRDS("output/SEM_models/fit_seeds_9_rec_shn.RDS")
...
fit_seeds_10 <- brm(
  ...
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_seeds_10_rec_shn"
)
fit_seeds_10 <- readRDS("output/SEM_models/fit_seeds_10_rec_shn.RDS")
...
fit_seeds_11 <- brm(
  ...
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_seeds_11_rec_shn"
)
fit_seeds_11 <- readRDS("output/SEM_models/fit_seeds_11_rec_shn.RDS")
...
fit_seeds_12 <- brm(
  ...
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_seeds_12_rec_shn"
)
fit_seeds_12 <- readRDS("output/SEM_models/fit_seeds_12_rec_shn.RDS")
...
fit_seeds_13 <- brm(
  ...
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_seeds_13_rec_shn"
)
fit_seeds_13 <- readRDS("output/SEM_models/fit_seeds_13_rec_shn.RDS")
...
fit_seeds_14 <- brm(
  ...
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_seeds_14_rec_shn"
)
fit_seeds_14 <- readRDS("output/SEM_models/fit_seeds_14_rec_shn.RDS")
...
fit_seeds_15 <- brm(
  ...
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_seeds_15_rec_shn"
)
fit_seeds_15 <- readRDS("output/SEM_models/fit_seeds_15_rec_shn.RDS")
...
bf_seeds <-  bf(ShnSeeds | mi() ~ StrIndex + multi_pol)
...
fit_sdlng_0 <- brm(
  ...
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_sdlng_0_rec_shn"
)
...
fit_sdlng_1 <- brm(
  ...
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_sdlng_1_rec_shn"
)
...
fit_sdlng_2 <- brm(
  ...
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_sdlng_2_rec_shn"
)
...
fit_sdlng_3 <- brm(
  ...
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_sdlng_3_rec_shn"
)
...
fit_sdlng_16 <- brm(
  ...
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_sdlng_16_rec_shn"
)
...
fit_sdlng_17 <- brm(
  ...
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_sdlng_17_rec_shn"
)
...
fit_sdlng_18 <- brm(
  ...
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_sdlng_18_rec_shn"
)
...
fit_sdlng_19 <- brm(
  ...
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_sdlng_19_rec_shn"
)
...
fit_final <- brm(
  ...
  data = data_scaled,
  chains = 4, cores = 4, iter = 4000,
  file = "output/SEM_models/fit_final_rec_shn"
)

fit_final <- readRDS(file = "output/SEM_models/fit_final_rec_shn.RDS")
summary(fit_final)
